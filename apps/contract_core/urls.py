...
urlpatterns = [
    ...
    path("catalogs/ak/<int:pk>/detail/", views.AkDetailHtmxView.as_view(), name="ak_detail_htmx"),
    ...
    path("catalogs/companies/<int:pk>/detail/", views.CompanyDetailHtmxView.as_view(), name="company_detail_htmx"),
