...
urlpatterns = [
    ...
    # Универсальный список договоров
    path("contracts/", views.ContractListView.as_view(), name="contract_list_all"),
    path("contracts/<slug:type_slug>/", views.ContractListView.as_view(), name="contract_list_by_type"),
